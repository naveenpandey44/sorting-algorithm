      ...
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="bg-gray-800 rounded-lg p-8 shadow-xl mb-10">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 text-white text-center"
              />
            </div>
          ...
          <div className="flex justify-center gap-6 mt-8">
            ...
            <button
              onClick={handleSort}
              className="px-8 py-3 bg-pink-600 hover:bg-pink-700 rounded-md transition-colors duration-200 font-medium text-lg"
            >
              Sort
            </button>
          </div>
          ...
          <div className="flex items-end justify-center h-[350px] gap-3">
            {array.map((value, index) => (
              <div key={index} className="flex flex-col items-center">
                <div
                  className="w-16 bg-gradient-to-t from-purple-600 to-pink-400 rounded-t-md transition-all duration-500 ease-in-out"
