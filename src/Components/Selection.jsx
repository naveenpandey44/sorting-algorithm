  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-teal-600">
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-xl mb-8">
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button
              ...
              className="px-6 py-2 bg-green-600 hover:bg-green-700 rounded-md transition-colors duration-200 font-medium"
            >
              Set Array
            </button>
            <button
              onClick={handleSort}
              className="px-6 py-2 bg-teal-600 hover:bg-teal-700 rounded-md transition-colors duration-200 font-medium"
            >
              Sort
            </button>
          </div>
          ...
          <div className="flex items-end justify-center h-[300px] gap-2">
            {array.map((value, index) => (
              <div key={index} className="flex flex-col items-center">
                <div
                  className="w-12 bg-gradient-to-t from-green-600 to-green-400 rounded-t-md transition-all duration-500 ease-in-out"
