        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-xl mb-8">
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button
              ...
              className="px-6 py-2 bg-blue-600 hover:bg-blue-700 rounded-md transition-colors duration-200 font-medium"
            >
              Set Array
            </button>
            <button
          ...
          <div className="flex items-end justify-center h-[300px] gap-2">
            {array.map((value, index) => (
              <div key={index} className="flex flex-col items-center">
                <div
                  className="w-12 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t-md transition-all duration-500 ease-in-out"
